...
<body>
    ...
    $id = $_SESSION['id'];
    // instruccion
    $producto = "SELECT *, concat(nombres,' ',apellidos) AS nombre_completo FROM empleados WHERE id_empleado = '$id'";
    // consulta
        ...
        <div class="container">
            <div class="profile-card">
                <div class="profile-header">
                    <!-- <img src="https://via.placeholder.com/100" alt="Foto de Perfil" class="profile-image"> -->
                    <h2><?php echo isset($info['nombre_completo']) ?  $info['nombre_completo'] : 'Anonimo' ?></h2>
                    <p><?php echo isset($info['usuario']) ?  $info['usuario'] : 'n/d' ?></p>
                </div>
                ...
                <div class="profile-options">
                    <a href="../paginas/editar_empleado.php?origen=perfil&id=<?php echo $id;?>" class="btn"><span class="material-icons">edit</span> Editar Perfil</a>
                    <a href="./actualizar_contrasena.php" class="btn"><span class="material-icons">password</span> Actualizar Contraseña</a>
