...
<body>
    <?php 
    include "./menu_panel.php"; include "../php/notificaciones.php"; 
    //Notificaciones
    ...
    <div class="main-content">
        <div class="contenido">
            ...
            <div class="container">
                <form action="../php/update_contrasena.php?origen=empleados" method="POST" class="form">
                ...
                <button onclick="window.location.href='./perfil_empleado.php';">Regresar al perfil</button>
            </div>
        </div>
    </div>
