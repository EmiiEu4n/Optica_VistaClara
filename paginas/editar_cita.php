...
<body>
    ...
    // instruccion
    $proveedor = "SELECT * FROM citas WHERE id_cita = '$id'";
            ...
            <div class="content-registrar formulario">
                <form action="../php/update_cita.php" method="POST">
                    ...
                    <fieldset>
                        ...
                        <input class="flatpickr" id="fecha" name="fecha" min="" max="" type="date" value="<?php echo "$info[fecha]" ?>"><br><br>
                        <label for="">Hora: <span>*</span></label>
                        <select id="hora" name="hora">
                            <option value="">Selecciona la hora de la cita</option>
                            <option value="10:00" <?php if ($info['hora'] == '10:00') echo 'selected'; ?>>10:00 AM</option>
                            <option value="11:00" <?php if ($info['hora'] == '11:00') echo 'selected'; ?>>11:00 AM</option>
                            <option value="12:00" <?php if ($info['hora'] == '12:00') echo 'selected'; ?>>12:00 PM</option>
                            <option value="01:00" <?php if ($info['hora'] == '01:00') echo 'selected'; ?>>01:00 PM</option>
                            <option value="02:00" <?php if ($info['hora'] == '02:00') echo 'selected'; ?>>02:00 PM</option>
                            <option value="03:00" <?php if ($info['hora'] == '03:00') echo 'selected'; ?>>03:00 PM</option>
                            <option value="04:00" <?php if ($info['hora'] == '04:00') echo 'selected'; ?>>04:00 PM</option>
                            <option value="05:00" <?php if ($info['hora'] == '05:00') echo 'selected'; ?>>05:00 PM</option>
                        </select><br><br>

                        <label for="">Motivo: <span>*</span></label><br>
                        <textarea name="motivo" id=""><?php echo "$info[motivo]" ?></textarea>
                    </fieldset>

                    <fieldset>
                        <legend>Información del cliente</legend>
                        <label for="buscar-cliente">Nombre:</label>
                        <input type="text" id="buscar-cliente" placeholder="Nombre del cliente Ej. Emiliano Euan Puc" name="nombre_cliente" value="<?php echo "$info[nombre_cliente]" ?>">
                        ...
                        <input name="id_cita" type="hidden" value="<?php echo $id ?>">
                    </fieldset>
                    <div class="opciones-btn opciones-btn-registrar">
                        <div style="width: 190px;" class="btn">
                            <a href="mostrar_citas.php">Regresar</a>
                        </div>
                        <button style="width: 190px;" class="btn-form" type="submit">Editar cita</button>
                    </div>
